...
async function predict(model, pessoa) {
    // transofrmar o array js para o tensor
    const tfInput = tf.tensor2d(pessoa);

    // Faz a predição (output será um vetor de 3 probabilidades)
    const pred = model.predict(tfInput);
    const predArray = await pred.array(); // Convertendo o tensor de volta para array
...
// normalizando idade da pessoa
// Exmplo: idade_min = 25, idade_max = 40, então idade_normalizada = (28 - 25) / (40 - 25) = 0.2
